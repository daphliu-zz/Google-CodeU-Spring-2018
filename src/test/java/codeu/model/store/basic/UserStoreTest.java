...
public class UserStoreTest {
  ...
  private final User USER_ONE =
      new User(UUID.randomUUID(), "test_username_one", Instant.ofEpochMilli(1000), true);
  private final User USER_TWO =
      new User(UUID.randomUUID(), "test_username_two", Instant.ofEpochMilli(2000), false);
  private final User USER_THREE =
      new User(UUID.randomUUID(), "test_username_three", Instant.ofEpochMilli(3000), false);
  ...
  public void testAddUser() {
    User inputUser = new User(UUID.randomUUID(), "test_username", Instant.now(), false);
