...
public class RegisterServletTest {
  ...
  public void testDoPost_NewUser() throws IOException, ServletException {
    ...
    Mockito.when(mockRequest.getParameter("password")).thenReturn("abcdtest");
    ...
    Assert.assertTrue(BCrypt.checkpw("abcdtest", userArgumentCaptor.getValue().getPassword()));
    Mockito.verify(mockResponse).sendRedirect("/login");
  }

  @Test
  public void testDoPost_IsRegistered() throws IOException, ServletException {
    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
